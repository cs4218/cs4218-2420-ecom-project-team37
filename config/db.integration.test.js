...
describe("MongoDB Connection", () => {
  ...
  test("should connect to MongoDB successfully", async () => {
    ...
    expect(console.log).toHaveBeenCalledWith(expect.stringContaining("Connected To Mongodb Database"));
  });
  ...
  test("should throw error if invalid mongoDB uri", async () => {
    ...
    expect(console.log).toHaveBeenCalledWith(expect.stringContaining("Error in Mongodb"));
  });
